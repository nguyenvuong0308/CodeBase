...
internal class AdPlaceModelMapper @Inject constructor(
    ...
    private fun toNativeAdPlace(
        ...
        return NativeAdPlace(
            ...
            primaryTextSizeDp = model.primaryTextSizeDp?.takeIf { it in 1..35 },
            bodyTextColor = model.bodyTextColor,
            bodyTextSizeDp = model.bodyTextSizeDp?.takeIf { it in 1..35 },
            ...
            ctaTextSizeDp = model.ctaTextSizeDp?.takeIf { it in 1..35 },
            ...
            alwaysHideInlineNative = model.alwaysHideInlineNative ?: false,
            nativeExpandMarginLeftDp = model.nativeExpandMarginLeftDp?.coerceAtLeast(0f) ?: 0f,
            nativeExpandMarginRightDp = model.nativeExpandMarginRightDp?.coerceAtLeast(0f) ?: 0f,
