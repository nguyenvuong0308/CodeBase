...
class LanguageActivityV2FromSettingManifestTest {
    ...
    fun `handles locale and layout direction changes without activity recreation`() {
        ...
        assertNotNull("LanguageActivityV2FromSetting must be declared", targetActivity)
    ...
    private companion object {
        ...
        const val ACTIVITY_NAME =
            "com.codebasetemplate.features.feature_language.ui.v2.LanguageActivityV2FromSetting"
    }
}
