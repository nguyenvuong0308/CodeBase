...
object OnBoardingConfigFactory {
    ...
    fun getOnboardingV3AdPlaceNames(introductionPosition: Int): List<IAdPlaceName> {
        return when (introductionPosition) {
            0 -> listOf(CoreAdPlaceName.ANCHORED_ONBOARDING_BOTTOM_V3_1)
            1 -> listOf(CoreAdPlaceName.ANCHORED_ONBOARDING_BOTTOM_V3_2)
            2 -> listOf(CoreAdPlaceName.ANCHORED_ONBOARDING_BOTTOM_V3_3)
            3 -> listOf(CoreAdPlaceName.ANCHORED_ONBOARDING_BOTTOM_V3_4)
            4 -> listOf(CoreAdPlaceName.ANCHORED_ONBOARDING_BOTTOM_V3_5)
            else -> listOf()
        }
    }
